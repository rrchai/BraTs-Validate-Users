config <- list(
  google_sheet_url = "",
  first_name_question = "What is your first name?", # your google form question for first name
  last_name_question = "What is your last name?", # your google form question for last name
  username_question = "What is your synapse user id?", # your google form question for user name
...
#   userID_question = "What is your synapse user id?",
